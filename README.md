...
3.  Under the **Assets** section, download the file for your operating system:
   * **Windows:** [NEI-MAILER-Windows.zip](https://github.com/tiagoalmeida03/nei-mailer/releases/download/v1.0.4/NEI-Mailer-Windows.zip)
   * **macOS:** [NEI-MAILER-macOS.zip](https://github.com/tiagoalmeida03/nei-mailer/releases/download/v1.0.4/NEI-Mailer-MacOS.zip)
   * **Linux:** [NEI-MAILER-Linux.tar.gz](https://github.com/tiagoalmeida03/nei-mailer/releases/download/v1.0.4/NEI-Mailer-Linux.tar.gz)
